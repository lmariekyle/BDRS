    ...
    <x-slot name="header">
        ...
        <div class="absolute top-0  mt-56 flex flex-col w-max sm:px-6 lg:ml-[20rem]">
            <div class=" bg-gold w-max self-end shadow-inner px-4 py-2 hover:shadow-md">
                <a href="{{route('unit-types.create')}}" class="text-center text-sm text-darkblue font-semibold hover:text-dirtywhite">Create Unit Type</a>
            </div>
                ...
                <table class="w-full  text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    @forelse ($unitTypes as $unitType)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{route('unit-types.edit', $unitType->id)}}" class="mr-5"><i class="fa-solid fa-pen"></i> </a>          
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="4">No Unit Type Found.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
