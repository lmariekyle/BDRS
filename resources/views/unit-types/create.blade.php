...
<div class=" flex flex-row sm:px-6 lg:-ml-9">
    ...
    @role('Marketing')
        <div class="flex flex-col items-center w-max mt-[15rem] sm:px-6 lg:ml-[35rem] bg-dirtywhite border-l-blue-950 shadow-md">
    @endrole       
                <p class="font-poppin mb-4 text-2xl underline underline-offset-8">Create Unit Type</p>
            <form method="POST" action="{{route('unit-types.store')}}" class="grid grid-cols-2 w-max h-max py-4" enctype="multipart/form-data">  
                @csrf
                <!-- Name -->
                <div class="mt-4 px-4">
